...
export declare type ExecuteTransactionRequestType = 'ImmediateReturn' | 'WaitForTxCert' | 'WaitForEffectsCert';
export declare type TransactionKindName = 'TransferObject' | 'Publish' | 'Call' | 'TransferSui' | 'ChangeEpoch';
...
export declare function getTransferSuiAmount(data: SuiTransactionKind): BN | null;
...
export declare function getTransactionEffects(data: SuiExecuteTransactionResponse): TransactionEffects | undefined;
