...
var Ed25519PublicKey = class {
  constructor(value) {
    if (checkPublicKeyData(value)) {
      ...
      if (typeof value === "string") {
        const buffer = Buffer2.from(value, "base64");
  ...
  toBuffer() {
    ...
    const zeroPad = Buffer2.alloc(PUBLIC_KEY_SIZE);
...
var Secp256k1PublicKey = class {
  ...
  toBuffer() {
    ...
    const zeroPad = Buffer3.alloc(SECP256K1_PUBLIC_KEY_SIZE);
...
function getTransferSuiAmount(data) {
  return "TransferSui" in data && data.TransferSui.amount ? new BN3.BN(data.TransferSui.amount, 10) : null;
}
...
var Coin = class {
  ...
  static getBalance(data) {
    ...
    return new BN4.BN(balance, 10);
  }
  static getZero() {
    return new BN4.BN("0", 10);
  }
  static getType(data) {
    if ("status" in data) {
...
var HexDataBuffer = class {
  constructor(data) {
    if (typeof data === "string") {
      this._data = new Uint8Array(Buffer5.from(data, "hex"));
    } else {
      this._data = data;
    }
  }
  ...
  toString() {
    return Buffer5.from(this._data).toString("hex");
  }
};
