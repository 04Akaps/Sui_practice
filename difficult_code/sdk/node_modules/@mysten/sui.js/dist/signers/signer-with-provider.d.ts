...
import { MoveCallTransaction, MergeCoinTransaction, PayTransaction, SplitCoinTransaction, TransferObjectTransaction, TransferSuiTransaction, TxnDataSerializer, PublishTransaction } from './txn-data-serializers/txn-data-serializer';
export declare abstract class SignerWithProvider implements Signer {
     ...
     * @param txBytes BCS serialised TransactionData bytes
     */
    signAndExecuteTransactionWithRequestType(txBytes: Base64DataBuffer, requestType: ExecuteTransactionRequestType): Promise<SuiExecuteTransactionResponse>;
    /**
